...
import StockCountInfoButton from './StockCountInfoButton'
import EnterAndScanNowButtons from './EnterAndScanNowButtons'
...
class CameraView extends Component {
    ...
    componentDidMount() {
        ...
        this.props.setScannedCharactersAction("123")
                    ...
                    >
                     ...
                     <View style={{
                        ...
                        <EnterAndScanNowButtons
                            ...
                            enterNowMethod={() => { this.props.navigation.navigate('DataCorrectionView') }}
                        />
                    </View>
                </Animated.View>
...
export default connect(mapDispatchToProps)(CameraView)